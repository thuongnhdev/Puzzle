...
public class Toast : MonoBehaviour
{
    ...
    public float offsetBackground = 100;
    ...
    public void SetMessage(string msg)
    {
        ...
        {
            backgroundTransform.sizeDelta = new Vector2(messageTransform.GetComponent<TextMeshProUGUI>().preferredWidth + offsetBackground, backgroundTransform.sizeDelta.y);
        });
    }
    ...
    public void ShowMessage(string msg, float time = 1.5f, bool isClear = false)
    {
        if (isClear)
        {
            queue.Clear();
